...
module.exports = {
  ...
  requirePassword: check("password")
    ...
    .withMessage(
      "Your Password must be a minimum of 4 characters or maximum character of 20",
    ),
  ...
  requireTitle: check("title")
    ...
    .withMessage("The Product Title should be between 3 and 20 characters"),
  requirePrice: check("price")
    .trim()
    .toFloat()
    .isFloat({ min: 1 })
    .withMessage("The Product Price must be a Number Greater than 1"),
};
